...
BLOG_AUTHOR = "Clearfree"  # (translatable)
BLOG_TITLE = "Clearfree"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://clearfree.co.uk/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://clearfree.co.uk/"
BLOG_EMAIL = "hello@topia.com"
BLOG_DESCRIPTION = "Clearfree Home"  # (translatable)
